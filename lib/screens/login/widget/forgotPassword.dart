...
Widget forgotPasswordEmail(context,TextEditingController forgotPasswordEmail,Function loading){
  ...
  return GestureDetector(
                  ...
                  children: [
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            TextHeading(text: 'Enter your registered email!'),
                            SizedBox(
                              height: 7,
                            ),
                            Padding(
    ...
    child: Center(
        child: TextHeading(text: "Forgot Username/Password?",)),
  );
}
